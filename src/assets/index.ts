...
export const DownloadIcon: RemixiconReactIconComponentType = DownloadLineIcon;
...
export const starIcons: RemixiconReactIconComponentType[] = [StarFillIcon, StarHalfLineIcon]
export const arrowIcons: RemixiconReactIconComponentType[] = [ArrowLeftSLineIcon, ArrowRightSLineIcon]
...
export const CheckIcon: RemixiconReactIconComponentType = CheckLineIcon;
